(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 55838, (e, r, t) => {
    "use strict";
    var a = e.r(15010),
        n = "function" == typeof Object.is ? Object.is : function(e, r) {
    ...
    var c = "u" < typeof window || void 0 === window.document || void 0 === window.document.createElement ? function(e, r) {
        return r()
    } : function(e, r) {
        var t = r(),
            a = o({
            ...
            c = a[1];
        return l(function() {
            n.value = t, n.getSnapshot = r, s(n) && c({
                inst: n
            })
        }, [e, t, r]), i(function() {
            return s(n) && c({
    ...
    var a = e.r(15010),
        ...
        s = a.useMemo,
        c = a.useDebugValue;
    t.useSyncExternalStoreWithSelector = function(e, r, t, a, n) {
        var p = l(null);
        if (null === p.current) {
            var m = {
                hasValue: !1,
        ...
        var d = i(e, (p = s(function() {
            function e(e) {
                if (!u) {
                    if (u = !0, i = e, e = a(e), void 0 !== n && m.hasValue) {
                        var r = m.value;
                        if (n(r, e)) return l = r
                    }
                    return l = e
                }
                if (r = l, o(i, e)) return r;
                var t = a(e);
                return void 0 !== n && n(r, t) ? (i = e, r) : (i = e, l = t)
            }
            var i, l, u = !1,
                s = void 0 === t ? null : t;
            return [function() {
    ...
    let r = e => {
        let r, t = new Set,
            a = (e, a) => {
                ...
                if (!Object.is(n, r)) {
                    let e = r;
                    r = (null != a ? a : "object" != typeof n || null === n) ? n : Object.assign({}, r, n), t.forEach(t => t(r, e))
                }
            },
            n = () => r,
            o = {
    ...
    e.s(["Theme", 0, function(e) {
        let o, u, s, c, p, m, d, h, C = (0, t.c)(19),
            {
                children: S,
                theme: g,
                global: f
        ...
        C[0] !== g ? (o = () => {
            A(g)
        }, u = [g], C[0] = g, C[1] = o, C[2] = u) : (o = C[1], u = C[2]), (0, n.useEffect)(o, u), C[3] !== F || C[4] !== f ? (s = () => {
            f && document.documentElement.setAttribute("data-theme", F)
        }, C[3] = F, C[4] = f, C[5] = s) : s = C[5], C[6] !== F || C[7] !== f || C[8] !== T ? (c = [T, F, f], C[6] = F, C[7] = f, C[8] = T, C[9] = c) : c = C[9], (0, n.useEffect)(s, c);
        let _ = i[F];
        C[10] !== F || C[11] !== _ ? (p = {
            name: F,
            theme: _
        }, C[10] = F, C[11] = _, C[12] = p) : p = C[12], C[13] === Symbol.for("react.memo_cache_sentinel") ? (m = {
            setTheme: A
        }, C[13] = m) : m = C[13], C[14] !== p ? (d = {
            state: p,
            actions: m
        }, C[14] = p, C[15] = d) : d = C[15];
        let M = d;
        return C[16] !== S || C[17] !== M ? (h = (0, r.jsx)(l.Provider, {
            value: M,
            children: S
        }), C[16] = S, C[17] = M, C[18] = h) : h = C[18], h
    }, "useTheme", 0, function() {
        let e = (0, n.useContext)(l);
        if (!e) throw Error("useTheme must be used within a Theme provider");
        return e
    }], 59635)
}, 7670, e => {
    "use strict";
    e.s(["default", 0, function() {
        for (var e, r, t = 0, a = "", n = arguments.length; t < n; t++)(e = arguments[t]) && (r = function e(r) {
            var t, a, n = "";
            if ("string" == typeof r || "number" == typeof r) n += r;
            else if ("object" == typeof r)
                if (Array.isArray(r)) {
                    var o = r.length;
                    for (t = 0; t < o; t++) r[t] && (a = e(r[t])) && (n && (n += " "), n += a)
                } else
                    for (a in r) r[a] && (n && (n += " "), n += a);
            return n
        }(e)) && (a && (a += " "), a += r);
        return a
    }])
    ...
    function c({
        ...
        let b = (0, r.u)(),
            [v, D] = function({
                ...
                var o, u, s;
                let c = a || ("u" < typeof window ? class {} : window.ResizeObserver);
                ...
                }), h = e ? "number" == typeof e ? e : e.scroll : null, C = e ? "number" == typeof e ? e : e.resize : null, S = (0, t.useRef)(!1);
                (0, t.useEffect)(() => (S.current = !0, () => void(S.current = !1)));
                let [g, f, T] = (0, t.useMemo)(() => {
                    let e = () => {
                        let e, r;
                        ...
                        let {
                            ...
                            x: c,
                            y: p
                        } = d.current.element.getBoundingClientRect(), h = {
                            left: t,
                            top: a,
                            width: o,
                            height: i,
                        ...
                        d.current.element instanceof HTMLElement && n && (h.height = d.current.element.offsetHeight, h.width = d.current.element.offsetWidth), Object.freeze(h), S.current && (e = d.current.lastBounds, r = h, !l.every(t => e[t] === r[t])) && m(d.current.lastBounds = h)
                    };
                    return [e, C ? i(e, C) : e, h ? i(e, h) : e]
                }, [m, n, h, C]);

                function F() {
                    d.current.scrollContainers && (d.current.scrollContainers.forEach(e => e.removeEventListener("scroll", T, !0)), d.current.scrollContainers = null), d.current.resizeObserver && (d.current.resizeObserver.disconnect(), d.current.resizeObserver = null), d.current.orientationHandler && ("orientation" in screen && "removeEventListener" in screen.orientation ? screen.orientation.removeEventListener("change", d.current.orientationHandler) : "onorientationchange" in window && window.removeEventListener("orientationchange", d.current.orientationHandler))
                }

                function A() {
                    d.current.element && (d.current.resizeObserver = new c(T), d.current.resizeObserver.observe(d.current.element), r && d.current.scrollContainers && d.current.scrollContainers.forEach(e => e.addEventListener("scroll", T, {
                        capture: !0,
                        passive: !0
                    })), d.current.orientationHandler = () => {
                        T()
                ...
                return o = T, u = !!r, (0, t.useEffect)(() => {
                    if (u) return window.addEventListener("scroll", o, {
                        capture: !0,
                        passive: !0
                    }), () => void window.removeEventListener("scroll", o, !0)
                }, [o, u]), s = f, (0, t.useEffect)(() => (window.addEventListener("resize", s), () => void window.removeEventListener("resize", s)), [s]), (0, t.useEffect)(() => {
                    F(), A()
                }, [r, T, f]), (0, t.useEffect)(() => F, []), [e => {
                    e && e !== d.current.element && (F(), d.current.element = e, d.current.scrollContainers = function e(r) {
                        let t = [];
                        ...
                        return [a, n, o].some(e => "auto" === e || "scroll" === e) && t.push(r), [...t, ...e(r.parentElement)]
                    }(e), A())
                }, p, g]
            }({
                scroll: !0,
            ...
            x = t.useRef(null),
            P = t.useRef(null);
        t.useImperativeHandle(e, () => x.current);
        let I = (0, r.a)(R),
            [w, U] = t.useState(!1),
            [N, O] = t.useState(!1);
        if (w) throw w;
        ...
        (0, r.b)(() => {
            let e = x.current;
            D.width > 0 && D.height > 0 && e && (k.current || (k.current = (0, r.c)(e)), async function() {
                await k.current.configure({
                    ...
                    onCreated: e => {
                        null == e.events.connect || e.events.connect(h ? (0, r.i)(h) ? h.current : h : P.current), C && e.setEvents({
                            compute: (e, r) => {
                                let t = e[C + "X"],
                                    a = e[C + "Y"];
                                r.pointer.set(t / r.size.width * 2 - 1, -(2 * (a / r.size.height)) + 1), r.raycaster.setFromCamera(r.pointer, r.camera)
                            }
                        }), null == L || L(e)
                    }
                }), k.current.render((0, s.jsx)(b, {
                    children: (0, s.jsx)(r.E, {
                        set: O,
                        children: (0, s.jsx)(t.Suspense, {
                            fallback: (0, s.jsx)(r.B, {
                                set: U
                            }),
    ...
    e.i(89499), e.s(["Canvas", 0, function(e) {
        return (0, s.jsx)(u.FiberProvider, {
            children: (0, s.jsx)(c, {
                ...e
            })
        })
    ...
    e.v(r => Promise.all(["static/chunks/0~p.rje6~zd8p.js", "static/chunks/02s.6q3~d8cqh.js"].map(r => e.l(r))).then(() => r(88954)))
}]);