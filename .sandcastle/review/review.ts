...
const validInlineComments: ReviewOutput["inlineComments"] = result.output.inlineComments.filter((c: ReviewOutput["inlineComments"][number]) => {
...
const validReplies: ReviewOutput["replies"] = result.output.replies.filter((r: ReviewOutput["replies"][number]) => {
