...
const validInlineComments: ImplementPrOutput["newInlineComments"] = result.output.newInlineComments.filter((c: ImplementPrOutput["newInlineComments"][number]) => {
...
const validThreadReplies: ImplementPrOutput["threadReplies"] = result.output.threadReplies.filter((r: ImplementPrOutput["threadReplies"][number]) => {
