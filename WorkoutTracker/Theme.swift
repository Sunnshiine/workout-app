...
enum Theme {
    ...
    static let rowFill = activePalette.rowFill
...
extension Theme {
    ...
    private static let darkPalette = Palette(
        ...
        exerciseGroupFill: Color(red: 0.035, green: 0.065, blue: 0.055).opacity(0.42),
        exerciseGroupStroke: Color(red: 0.72, green: 0.82, blue: 0.75).opacity(0.10),
        ...
        rowFill: Color(red: 0.060, green: 0.075, blue: 0.065).opacity(0.36),
    ...
    private static let blackPalette = Palette(
        ...
        exerciseGroupFill: Color(red: 0.006, green: 0.018, blue: 0.014).opacity(0.44),
        exerciseGroupStroke: Color(red: 0.70, green: 0.80, blue: 0.74).opacity(0.09),
        ...
        rowFill: Color(red: 0.018, green: 0.030, blue: 0.024).opacity(0.38),
    ...
    private static let mintGreenPalette = Palette(
        ...
        exerciseGroupFill: Color(red: 0.030, green: 0.100, blue: 0.070).opacity(0.42),
        exerciseGroupStroke: Color(red: 0.74, green: 0.90, blue: 0.80).opacity(0.10),
        ...
        rowFill: Color(red: 0.050, green: 0.100, blue: 0.075).opacity(0.36),
    ...
    private static let sageLightPalette = Palette(
        ...
        exerciseGroupFill: Color(red: 0.93, green: 0.95, blue: 0.89).opacity(0.78),
        exerciseGroupStroke: Color(red: 0.42, green: 0.58, blue: 0.47).opacity(0.22),
        ...
        rowFill: Color(red: 0.90, green: 0.93, blue: 0.86).opacity(0.72),
    ...
    private static let blueLightPalette = Palette(
        ...
        exerciseGroupFill: Color(red: 0.95, green: 0.975, blue: 1.0).opacity(0.78),
        exerciseGroupStroke: Color(red: 0.42, green: 0.52, blue: 0.70).opacity(0.22),
        ...
        rowFill: Color(red: 0.92, green: 0.955, blue: 0.995).opacity(0.72),
