...
for name in ("block-grid", "exercise-history", "exercise-history2", "exercise-history3", "exercise-history4", "exercise-history5", "exercise-history6", "block-grid-scale", "block-grid-focus", "block-grid-focus2"):
